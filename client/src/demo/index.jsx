...
function Curriculum() {
  const [CurriculumInitialFormData, setCurriculumInitialFormData] = useState([
    {
      title: "",
      videoUrl: "",
      freePreview: false,
  ...
  const changeFormData = (indexs, field, value) => {
    ...
    setCurriculumInitialFormData(updatedarray);
  };
  //...................................................
    ...
    if (selected) {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setCurriculumInitialFormData(copyCurriculumInitialData);
